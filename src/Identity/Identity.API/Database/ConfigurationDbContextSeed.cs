...
namespace Identity.API.Database
{
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context, IConfiguration configuration)
        {
            ...
            {
                foreach (var client in IdentityResourceConfig.GetClients(clientUrls))
                {
            ...
            {
                foreach (var api in IdentityResourceConfig.GetApis())
                {
            ...
            {
                foreach (var resource in IdentityResourceConfig.GetApiScopes())
                {
